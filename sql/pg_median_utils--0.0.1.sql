...
CREATE FUNCTION rolling_median(double precision, int) RETURNS double precision
AS '$libdir/pg_median_utils'
LANGUAGE C IMMUTABLE STRICT WINDOW PARALLEL SAFE;

CREATE FUNCTION backfilled_rolling_median(double precision, int) RETURNS double precision
AS '$libdir/pg_median_utils'
LANGUAGE C IMMUTABLE STRICT WINDOW PARALLEL SAFE;

CREATE FUNCTION rolling_median_impute(double precision, int) RETURNS double precision
AS '$libdir/pg_median_utils'
LANGUAGE C IMMUTABLE STRICT WINDOW PARALLEL SAFE;